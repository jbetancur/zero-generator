// Inspired by https://github.com/gaearon/overreacted.io/blob/master/src/components/Toggle.js
...
const Toggle: React.FC<IToggleThemeProps> = ({ checked = false, onClick }) => {
	...
	return (
		<ToggleContainer hasFocus={hasFocus}>
			<input
				id="toggleTheme"
				type="checkbox"
				title={title}
...
const ToggleContainer = styled.div<IToggleContainer>`
	...
	label span {
		...
		background: #fff;
		${({ hasFocus }) => hasFocus && 'box-shadow: 0 0 2px 4px rgba(189, 189, 189, 1)'};
	}
